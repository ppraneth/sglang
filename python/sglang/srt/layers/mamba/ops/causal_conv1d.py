...
# This is a placeholder value. Ensure it's consistent with SGLang's internal padding if any.
PAD_SLOT_ID = -1
...
def _causal_conv1d_fwd_kernel(
    ...
    # This is the full Triton kernel from vLLM.
    ...
    for idx_token in range(segment_len):
        ...
        if KERNEL_WIDTH == 2:
            ...
            col0, col1 = col1, matrix_x
        elif KERNEL_WIDTH == 4:
            col0, col1, col2 = col1, col2, matrix_x
        if SILU_ACTIVATION:
