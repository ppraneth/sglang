...
void set_ssm_params_fwd(SSMParamsBase &params,
                            ...
                            const size_t dstate, const size_t n_groups,
                            const bool is_variable_B, const bool is_variable_C,
                            const torch::Tensor u, torch::Tensor delta,
                            const torch::Tensor A, const torch::Tensor B, const torch::Tensor C,
                            torch::Tensor out, const torch::Tensor z,
                            torch::Tensor out_z, const std::optional<at::Tensor>& D,
                            const std::optional<at::Tensor>& delta_bias,
                            torch::Tensor ssm_states, bool has_z,
                            bool delta_softplus,
                            const std::optional<at::Tensor>& query_start_loc,
                            const std::optional<at::Tensor>& cache_indices,
                            const std::optional<at::Tensor>& has_initial_state,
                            bool varlen, int64_t pad_slot_id) {
...
void selective_scan_fwd(const torch::Tensor &u, const torch::Tensor &delta,
    ...
    set_ssm_params_fwd(params, batch_size, dim, seqlen, dstate, n_groups, is_variable_B, is_variable_C,
                       ...
                       D_, delta_bias_, ssm_states, has_z, delta_softplus,
